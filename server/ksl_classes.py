...
class KSLClassManager:
    ...
    def _initialize_basic_classes(self):
        ...
        # === 기본 모음 클래스 템플릿 (YUBEEN, 정재연 정의) ===
        basic_vowels = [
            ("ㅏ", "아 모음 - 손바닥을 앞으로, 검지 위로"),
            ("ㅑ", "야 모음 - 손바닥을 앞으로, 검지+중지 위로"),
            ("ㅓ", "어 모음 - 손바닥을 몸 쪽으로, 검지 위로"),
            ("ㅕ", "여 모음 - 손바닥을 몸 쪽으로, 검지+중지 위로"),
            ("ㅗ", "오 모음 - 주먹을 쥐고 엄지를 위로"),
            ("ㅛ", "요 모음 - 주먹을 쥐고 엄지를 위로, 검지 추가"),
            ("ㅜ", "우 모음 - 주먹을 쥐고 엄지를 아래로"),
            ("ㅠ", "유 모음 - 주먹을 쥐고 엄지를 아래로, 검지 추가"),
